function Hero() {
  return (
    <section className="container mx-auto min-h-screen flex items-center px-6 md:px-12 lg:px-24 py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center w-full">
        
        {/* Text Section */}
        <div className="space-y-8">
          <h1 className="font-extrabold text-4xl sm:text-5xl lg:text-6xl text-center md:text-left leading-tight">
          ...
          <div className="flex justify-center md:justify-start">
            <a
              href="#portfolio"
              className="inline-flex items-center space-x-3 px-8 py-4 bg-theme text-white font-semibold rounded-lg shadow-lg hover:opacity-90 transition"
            >
              <svg
                width="22"
                height="22"
        ...
        {/* Optional: Add an image or illustration on the right */}
        {/* <div className="hidden md:flex justify-center items-center">
          <img src="/your-image.svg" alt="Software Illustration" className="max-w-full h-auto" />
        </div> */}
