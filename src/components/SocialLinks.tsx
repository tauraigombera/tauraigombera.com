function SocialLinks() {
  return (
    <div>
      <ul className="flex flex-wrap items-center gap-6 text-sm font-medium sm:mt-0">
        ...
        <li>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M13.68 10.62L20.24 3h-1.55L13 9.62L8.45 3H3.19l6.88 10.01L3.19 21h1.55l6.01-6.99l4.8 6.99h5.24l-7.13-10.38Zm-2.13 2.47l-.7-1l-5.54-7.93H7.7l4.47 6.4l.7 1l5.82 8.32H16.3z" stroke-width="0.5" stroke="currentColor"/></svg>
          </a>
        </li>
